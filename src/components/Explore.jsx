    ...
    <section className='min-h-[400px] mb-16 lg:mb-4'>
      <div className='container mx-auto h-full'>
        <div className='h-full bg-explore bg-no-repeat bg-cover p-14 flex flex-col items-start justify-center'>
          ...
          Are you ready to embark on a journey into the exciting world of VR? We're dedicated to keeping you at the forefront of this thrilling technological revolution. Don't miss out on the latest news, groundbreaking innovations, and exclusive promotions that will take your VR experience to the next level!
          </p>
          {/* form */}
