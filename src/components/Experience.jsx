  ...
  return (
    <section className='mb-12 lg:mb-24'>
      <div className='container mx-auto'>
        <div className='flex flex-col min-h-[480px] lg:space-x-20 lg:flex-row md:mt-10'>
          ...
          <div className='flex-1 flex flex-col items-start justify-center mt-6 lg:mt-0' data-aos="fade-left" data-aos-offset="400">
            ...
            <p className='font-secondary mb-6'>Discover the best VR headsets, controllers, and accessories to enhance your gaming experience. We provide comprehensive buying guides to help you choose the perfect setup.</p>
